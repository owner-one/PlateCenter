	...
	export default {
		...
		methods: {
			loadProjects: function() {
				var that = this;
				this.axios.get('/api/webserver/mapi/api.php/viewMoldProjectInfo').then(function(res) {
					if (res != null) {
			...
			handle: function(message) {
				var that = this;
				var url = '/api/webserver/mapi/api.php/viewMoldOnes?filter=uuid,eq,' + message;
				this.axios.get(url).then(function(res) {
					if (res != null) {
						...
						var url2 = '/api/webserver/mapi/api.php/viewMoldProjectPart?filter=MoldProjectCode,eq,' + message;
						...
						var url3 = '/api/webserver/mapi/api.php/viewWorkTaskRecordAndContentToChartInfo?filter=MoldProjectCode,eq,' +
							message;
						...
						var urls = '/api/webserver/mapi/api.php/viewMoldProjectInfo?filter=MoldProjectName,eq,' +
							that.msg;
						...
						var url4 = '/api/webserver/mapi/api.php/viewMoldProjectPlanToChartInfo?filter=MoldProjectCode,eq,' +
							message;
						...
						var url5 = '/api/webserver/mapi/api.php/viewWorkTaskRecordAndContentToChartInfo?filter=MoldProjectCode,eq,' +
							message;
						...
						var url6 = '/api/webserver/mapi/api.php/viewWorkTaskEventRecordToChartInfo?filter=ChainedWorkTaskUuid,sw,' +
							that.msg;
						...
						var url7 = '/api/webserver/mapi/api.php/ViewManufacturingPartActivity?filter=MoldProjectCode,sw,' +
							message;
